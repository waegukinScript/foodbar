...
exports.postUpdateEvent = (req, res, next) => {
  ...
  Event.findById({ _id: id }, (err, event) => {
    if (err) {
      ...
      event.selectEvent = obj.selectEvent;
      event.save((err) => {
        if (err) {
          return next(err);
        }
      ...
      const html = `
                    ...
                    <div style="margin-top: 50px">
                      ...
                      <table border="1">
                        ...
                        <tr>
                          <td class="heading">Selected Event</td>
                          <td class="value">${event.selectEvent}</td>
                        </tr>
                      </table>
                  </div>
          `;
      ...
      const html = `
                    ...
                    <div style="margin-top: 50px">
                      ...
                      <table border="1">
                        ...
                        <tr>
                          <td class="heading">Event Place</td>
                          <td class="value">${eventPlace.eventPlace}</td>
                        </tr>
                        <tr>
